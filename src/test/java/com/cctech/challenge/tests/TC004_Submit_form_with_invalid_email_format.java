...
public class TC004_Submit_form_with_invalid_email_format extends BaseClass {
	...
	void Submit_form_with_valid_data() {
		...
		// Enter invalid Email
		formpage.enterEmail(p.getProperty("invalidemail"));
		ExtentReportManager.getTest().info("Entered invalid Email:" + " " + p.getProperty("invalidemail"));
